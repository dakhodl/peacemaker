...
SVG
  ...
  def arrow_sm_down
    <<-SVG.strip.html_safe
<svg class="-ml-1 mr-0.5 flex-shrink-0 self-center h-5 w-5 text-rose-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
